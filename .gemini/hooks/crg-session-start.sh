...
msg="$(code-review-graph status --repo "/Users/jiangs/Documents/Codex/2026-07-24/ai-product-design-plugin-product-design-2/outputs/radius-live-edition" 2>&1 | head -n 1 || true)"
